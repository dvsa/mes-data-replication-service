...
--   CONSTRAINT PK_REF_DATA_ITEM_MASTER PRIMARY KEY (CATEGORY_ID, ITEM_ID)
  CONSTRAINT PK_REF_DATA_ITEM_MASTER PRIMARY KEY (ITEM_ID)
);
...
ALTER TABLE POSTING ADD INDEX PO_TC_ID(TC_ID);
...
-- helps the select work_schedule_slots query
ALTER TABLE BOOKING ADD INDEX BKG_STATE_CODE(STATE_CODE);
...
-- 	SENT_FOR_SCANNING BIT NULL,
	CONSTRAINT ARI_BK_ID_PK PRIMARY KEY (BOOKING_ID)
);
