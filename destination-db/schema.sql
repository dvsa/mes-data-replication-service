...
--  FREE_RETEST_IND TINYINT NOT NULL,
--  FREE_TEST_IND TINYINT NOT NULL,
--  MEDICAL_IND TINYINT NULL,
--  MEETING_PLACE_REQ_IND TINYINT NOT NULL,
	MEETING_PLACE_REQ_TEXT VARCHAR(512) NULL,
--  PREF_EARLIEST_DATE DATETIME NULL,
--  PREF_INS_OVERRIDE_IND TINYINT NOT NULL,
...
-- 	TRAINER_PROFILE_OVERRIDE_IND TINYINT NOT NULL,
...
-- 	PREF_WEEKDAY_IND TINYINT NOT NULL,
-- 	PREF_EVENING_IND TINYINT NOT NULL,
-- 	PREF_SAT_IND TINYINT NOT NULL,
-- 	PREF_SUN_IND TINYINT NOT NULL,
...
(	APP_ID BIGINT NOT NULL,
	...
	BOOKING_ID BIGINT NOT NULL,
-- 	SENT_FOR_SCANNING TINYINT NULL,
...
-- 	TEST_SERVICE_DESCRIPTION VARCHAR(50) NOT NULL,
 	...
 	SPECIAL_NEEDS_CODE VARCHAR(20) NOT NULL,
-- 	MEETING_PLACE_IND TINYINT NOT NULL,
-- 	START_DATE DATETIME NOT NULL,
...
-- 	PAYMENT_RECEIPT_REQD_IND TINYINT NOT NULL,
...
-- 	IS_HISTORIC TINYINT NULL,
-- 	IS_VANITY_ADDRESS TINYINT NULL,
-- 	IS_WELSH_ADDRESS TINYINT NULL,
-- 	COUNTRY_CODE BIGINT NULL,
-- 	IS_INSECURE_ADDRESS TINYINT NULL,
...
-- 	CURRENT_CERTIFICATE TINYINT NULL,
...
-- 	ELIGIBILITY_RESEND_IND TINYINT NULL,
-- 	ADIHPT_SEND_IND TINYINT NULL,
...
-- 	USE_BUSINESS_ADDRESS_IND TINYINT NULL,
-- 	TEST_GAP_MINUTES SMALLINT NULL,
-- 	CPD_IND TINYINT NULL,
-- 	COMMENTS VARCHAR(1024) NULL,
-- 	REJECTION_REASON_CODE BIGINT NULL,
-- 	EU_LICENCE_TRANSFER_IND TINYINT NULL,
-- 	COP_IND TINYINT NULL,
...
-- 	VAT_REGISTERED TINYINT NULL,
-- 	COMMUNICATION_PREFERENCE_CODE BIGINT NULL,
-- 	PREFERRED_TEST_CENTRE_ID BIGINT NULL,
-- 	AREA_ID BIGINT NULL,
-- 	SECTOR_ID BIGINT NULL,
-- 	STATUS_CODE BIGINT NULL,
-- 	UNUSED_DL196_CERTS TINYINT NULL,
-- 	REFUND_REQUIRED TINYINT NULL,
-- 	UPDATED_BY BIGINT NOT NULL,
-- 	UPDATED_ON DATETIME NOT NULL,
-- 	CREATED_BY BIGINT NOT NULL,
-- 	CREATED_ON DATETIME NOT NULL,
...
-- 	AUTO_NCT_IND TINYINT NULL,
-- 	CREATED_ON DATETIME NOT NULL,
-- 	CREATED_BY BIGINT NOT NULL,
-- 	UPDATED_ON DATETIME NOT NULL,
-- 	UPDATED_BY BIGINT NOT NULL,
-- 	VEHICLE_REG_NUMBER_REQD TINYINT NULL,
-- 	MEETING_PLACE_REQD TINYINT NULL,
-- 	ADI_PRN_REQD TINYINT NULL,
-- 	TEST_CATEGORY_GROUP_CODE BIGINT NULL,
-- 	INTEREST_ID BIGINT NULL,
-- 	MIN_CANDIDATE_NOTICE_TIME DATETIME NULL,
-- 	IS_NOMINATED_TB_CATEGORY TINYINT NOT NULL,
...
-- Covering Index that helps the advanced-test-slot query
