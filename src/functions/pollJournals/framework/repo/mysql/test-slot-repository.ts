...
/* tslint:disable */
  ...
  booking_details.special_needs_code as special_needs_code, booking_details.vehicle_slot_type_code as vehicle_slot_type_code,
...
WORK_SCHEDULE_SLOTS w
 ...
 left join (
    select b.booking_id as booking_id, b.app_id as app_id, b.slot_id as slot_id,
      ...
      ts.extended_ind as special_needs_extended_test, ts.special_needs_code as special_needs_code, ari.booking_seq as booking_seq,
