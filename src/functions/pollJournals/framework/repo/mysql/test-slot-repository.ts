...
const getQuery = (ids: number[]) => {
 ...
 select w.slot_id, w.start_time as start_time, w.minutes as minutes,
     ...
     booking_details.date_of_birth as candidate_date_of_birth,
     booking_details.gender_code as candidate_gender_code,
     booking_details.ethnic_origin_code as candidate_ethnic_origin_code,
